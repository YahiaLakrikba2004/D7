...
*/
/*const concatenaStringhe = (str1, str2) => {
...
console.log(generaArrayRandom)

/* ESERCIZIO 3 (filter)
  Scrivi una funzione per ricavare solamente i valori PARI da un array composto da soli valori numerici
*/
/*function estraiPari(array) {
...
/*function incrementaArray(arr, n) {
  return arr.map(valore => valore + n);
}
...
function filmPiuVecchio(movies) {
  ...
  for (let i = 1; i < movies.length; i++) {
    if (movies[i].Year < piuVecchio.Year) {
      piuVecchio = movies[i]
    }
  }
...
function filmDelMillennio(movies) {
...
*/
function indicePrimoFilm(movies, anno) {
